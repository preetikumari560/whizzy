  ...
  return (
    <section className="flex flex-col md:flex-row items-center justify-between gap-10 px-8 md:px-20 py-12 bg-[#f0f0f0] mt-10">
      ...
      <div className="w-full md:w-1/2 text-center md:text-left order-last md:order-first">
        <h2 className="text-3xl md:text-4xl lg:text-4xl font-bold text-gray-800 leading-tight">
          {title}
        </h2>
        ...
        <button className="mt-8 px-6 py-3 bg-[#5e7627] text-white rounded-lg shadow-md hover:bg-[#4b601f] transition">
          Explore Products
        </button>
      </div>
